...
. /www/data/lang/$lang/mpserver.po
%>
            ...
            <div class="wrap-form">
             <form class="form-info" id="form0">
               <label>
                   <div class="name"></div>
                   <div>
                       <input type="checkbox" onclick="mask_method()" value="1" name="mptcp" <% [ `uci get gargoyle.global.mptcp` = 1 ]  && echo checked %>/><%= $enable%><%= $server%>
                   </div>
               </label>
               <div id="mask">
                 <label >
                ...
                <label >
                    ...
                    <div>
                      <select name="interface" >
                        <option value="wan1" <% [ `uci get gargoyle.global.master` = "3g-wan1" ] && echo 'selected="true"' %>>4G 1</option>
                        <option value="wan2" <% [ `uci get gargoyle.global.master` = "3g-wan2" ] && echo 'selected="true"' %>>4G 2</option>
                        <option value="wan3" <% [ `uci get gargoyle.global.master` = "3g-wan3" ] && echo 'selected="true"' %>>4G 3</option>
                        <option value="wan4" <% [ `uci get gargoyle.global.master` = "3g-wan4" ] && echo 'selected="true"' %>>4G 4</option>
